...
namespace IO.Swagger.Model
{
    ...
    public partial class RenewTokenRequest :  IEquatable<RenewTokenRequest>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as RenewTokenRequest);
        }

        /// <summary>
        /// Returns true if RenewTokenRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of RenewTokenRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RenewTokenRequest input)
        {
            if (input == null)
                return false;
