...
namespace IO.Swagger.Model
{
    ...
    public partial class OutputParameters :  IEquatable<OutputParameters>, IValidatableObject
    {
        ...
        public OutputParameters(int? a = default(int?))
        {
            this.A = a;
        }
        ...
        {
            return this.Equals(input as OutputParameters);
        }

        /// <summary>
        /// Returns true if OutputParameters instances are equal
        /// </summary>
        /// <param name="input">Instance of OutputParameters to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OutputParameters input)
        {
            if (input == null)
                return false;
