...
namespace IO.Swagger.Api
{
    ...
    /// </summary>
    public interface IPredictorScoringApi : IApiAccessor
    {
        ...
        ApiResponse<WebServiceResult> PredictorScoringWithHttpInfo (InputParameters webServiceParameters);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<WebServiceResult> PredictorScoringAsync (InputParameters webServiceParameters);
        ...
        System.Threading.Tasks.Task<ApiResponse<WebServiceResult>> PredictorScoringAsyncWithHttpInfo (InputParameters webServiceParameters);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class PredictorScoringApi : IPredictorScoringApi
    {
        private IO.Swagger.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="PredictorScoringApi"/> class.
        /// </summary>
        /// <returns></returns>
        public PredictorScoringApi(String basePath)
        {
        ...
        /// <returns></returns>
        public PredictorScoringApi(IO.Swagger.Client.Configuration configuration = null)
        {
        ...
        public ApiResponse< List<string> > CancelAndDeleteBatchExecutionWithHttpInfo (string executionId)
        {
            ...
            if (executionId == null)
                throw new ApiException(400, "Missing required parameter 'executionId' when calling PredictorScoringApi->CancelAndDeleteBatchExecution");

            var localVarPath = "/api/predictor_scoring/1.0/batch/{executionId}";
        ...
        public ApiResponse< System.IO.Stream > GetBatchExecutionFileWithHttpInfo (string executionId, int? index, string fileName)
        {
            // verify the required parameter 'executionId' is set
            if (executionId == null)
                throw new ApiException(400, "Missing required parameter 'executionId' when calling PredictorScoringApi->GetBatchExecutionFile");
            // verify the required parameter 'index' is set
            if (index == null)
                throw new ApiException(400, "Missing required parameter 'index' when calling PredictorScoringApi->GetBatchExecutionFile");
            // verify the required parameter 'fileName' is set
            if (fileName == null)
                throw new ApiException(400, "Missing required parameter 'fileName' when calling PredictorScoringApi->GetBatchExecutionFile");

            var localVarPath = "/api/predictor_scoring/1.0/batch/{executionId}/{index}/files/{fileName}";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
        ...
        public ApiResponse< List<string> > GetBatchExecutionFilesWithHttpInfo (string executionId, int? index)
        {
            // verify the required parameter 'executionId' is set
            if (executionId == null)
                throw new ApiException(400, "Missing required parameter 'executionId' when calling PredictorScoringApi->GetBatchExecutionFiles");
            // verify the required parameter 'index' is set
            if (index == null)
                throw new ApiException(400, "Missing required parameter 'index' when calling PredictorScoringApi->GetBatchExecutionFiles");

            var localVarPath = "/api/predictor_scoring/1.0/batch/{executionId}/{index}/files";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
        ...
        public ApiResponse< BatchWebServiceResult > GetBatchExecutionStatusWithHttpInfo (string executionId, bool? showPartialResults = null)
        {
            // verify the required parameter 'executionId' is set
            if (executionId == null)
                throw new ApiException(400, "Missing required parameter 'executionId' when calling PredictorScoringApi->GetBatchExecutionStatus");
            ...
            if (executionId != null) localVarPathParams.Add("executionId", this.Configuration.ApiClient.ParameterToString(executionId)); // path parameter
            if (showPartialResults != null) localVarQueryParams.AddRange(this.Configuration.ApiClient.ParameterToKeyValuePairs("", "showPartialResults", showPartialResults)); // query parameter
            ...
            return new ApiResponse<BatchWebServiceResult>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (BatchWebServiceResult) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(BatchWebServiceResult)));
        }
        ...
        public ApiResponse< List<string> > GetBatchExecutionsWithHttpInfo ()
        {
            ...
            var localVarPath = "/api/predictor_scoring/1.0/batch";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
        ...
        /// <param name="webServiceParameters">Input parameters to the web service.</param>
        /// <returns>WebServiceResult</returns>
        public WebServiceResult PredictorScoring (InputParameters webServiceParameters)
        {
             ApiResponse<WebServiceResult> localVarResponse = PredictorScoringWithHttpInfo(webServiceParameters);
             return localVarResponse.Data;
        }
        ...
        /// <param name="webServiceParameters">Input parameters to the web service.</param>
        /// <returns>ApiResponse of WebServiceResult</returns>
        public ApiResponse< WebServiceResult > PredictorScoringWithHttpInfo (InputParameters webServiceParameters)
        {
            // verify the required parameter 'webServiceParameters' is set
            if (webServiceParameters == null)
                throw new ApiException(400, "Missing required parameter 'webServiceParameters' when calling PredictorScoringApi->PredictorScoring");

            var localVarPath = "/api/predictor_scoring/1.0";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            {
                localVarPostBody = this.Configuration.ApiClient.Serialize(webServiceParameters); // http body (model) parameter
            }
            else
            {
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("PredictorScoring", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<WebServiceResult>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (WebServiceResult) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(WebServiceResult)));
        }
        ...
        /// <param name="webServiceParameters">Input parameters to the web service.</param>
        /// <returns>Task of WebServiceResult</returns>
        public async System.Threading.Tasks.Task<WebServiceResult> PredictorScoringAsync (InputParameters webServiceParameters)
        {
             ApiResponse<WebServiceResult> localVarResponse = await PredictorScoringAsyncWithHttpInfo(webServiceParameters);
             return localVarResponse.Data;
        ...
        /// <param name="webServiceParameters">Input parameters to the web service.</param>
        /// <returns>Task of ApiResponse (WebServiceResult)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<WebServiceResult>> PredictorScoringAsyncWithHttpInfo (InputParameters webServiceParameters)
        {
            // verify the required parameter 'webServiceParameters' is set
            if (webServiceParameters == null)
                throw new ApiException(400, "Missing required parameter 'webServiceParameters' when calling PredictorScoringApi->PredictorScoring");
        ...
        public ApiResponse< StartBatchExecutionResponse > StartBatchExecutionWithHttpInfo (List<InputParameters> batchWebServiceParameters, int? parallelCount = null)
        {
            ...
            if (batchWebServiceParameters == null)
                throw new ApiException(400, "Missing required parameter 'batchWebServiceParameters' when calling PredictorScoringApi->StartBatchExecution");
            ...
            if (parallelCount != null) localVarQueryParams.AddRange(this.Configuration.ApiClient.ParameterToKeyValuePairs("", "parallelCount", parallelCount)); // query parameter
            if (batchWebServiceParameters != null && batchWebServiceParameters.GetType() != typeof(byte[]))
            {
                localVarPostBody = this.Configuration.ApiClient.Serialize(batchWebServiceParameters); // http body (model) parameter
            }
            else
            {
            ...
            return new ApiResponse<StartBatchExecutionResponse>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (StartBatchExecutionResponse) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(StartBatchExecutionResponse)));
        }
